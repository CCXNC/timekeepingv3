	    	...
	    	<form method="POST" action="<?php echo base_url(); ?>index.php/reports/edit_ob/<?php echo $ob->id; ?>">
	    		<div style="color:red"><?php echo validation_errors(); ?> </div>
					...
					<div class="form-group">
						...
						<input id="form_name" type="text" readonly="" class="form-control" value="<?php echo $ob->name; ?>">
						<input type="hidden" name="name" value="<?php echo $ob->name . '|' . $ob->employee_number; ?>">
					</div>
						</div>
						<div class="col-md-5">
					<div class="form-group">
				...
				<div class="row">
					<div class="col-md-5">
						<div class="form-group">
							...
							<input type="time" name="time_of_departure" class="form-control" value="<?php echo $ob->time_in; ?>">
						</div>
					</div>
					<div class="col-md-5">
						<div class="form-group">
