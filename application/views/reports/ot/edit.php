	    ...
	    <div class="panel-body">
	    	...
	    	<form method="POST" action="<?php echo base_url(); ?>index.php/reports/edit_ot/<?php echo $ot->id; ?>">
	            ...
	            <div class="form-group">
	                ...
	                <input id="form_name" type="date" name="date" readonly="" class="form-control" value="<?php echo $ot->date_ot; ?>">
	            </div>
	          </div>
			   	</div>	
			   	<div class="row">
	            ...
	            <div class="form-group">
	              <label for="form_name">EMPLOYEE NAME</label>
	              		<input id="form_name" type="text" readonly="" class="form-control" value="<?php echo $ot->name; ?>">
	              		<input type="hidden" name="name" value="<?php echo $ot->name; ?>">
	              		<input type="hidden" name="employee_number" value="<?php echo $ot->employee_number; ?>">
	            </div>
			   		</div>
			   	</div>	
			  	<div class="row">
