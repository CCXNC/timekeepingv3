...
class Users_model extends CI_Model {
	...
	public function get_slvl_all_by_headCAM($start_date, $end_date, $department_id)
	{
		...
		$this->db->where('tbl_slvl.date >=', $start_date);
		$this->db->where('tbl_slvl.date <=', $end_date);
		$this->db->where('(tbl_slvl.status = "FOR APPROVAL" AND admin1.department_id = '. 2 .' OR admin1.department_id = '. 5 . ' AND tbl_slvl.status = "FOR APPROVAL" OR admin1.is_rfa = '. 1 . ' AND tbl_slvl.status = "FOR APPROVAL" OR admin1.is_fa != '. 0 .' AND tbl_slvl.status = "FOR APPROVAL"  OR tbl_slvl.status = "FOR NOTED")');
	...
	public function get_ut_all_by_headCAM($start_date, $end_date, $department_id)
	{
		...
		$this->db->where('tbl_undertime.date_ut >=', $start_date);
		$this->db->where('tbl_undertime.date_ut <=', $end_date);
		$this->db->where('(tbl_undertime.status = "FOR APPROVAL" AND admin1.department_id = '. 2 .' OR admin1.department_id = '. 5 . ' AND tbl_undertime.status = "FOR APPROVAL" OR admin1.is_rfa = '. 1 . ' AND tbl_undertime.status = "FOR APPROVAL" OR admin1.is_fa != '. 0 .' AND tbl_undertime.status = "FOR APPROVAL"  OR tbl_undertime.status = "FOR NOTED")');
	...
	public function get_ot_all_by_headCAM($start_date, $end_date, $department_id)
	{
		...
		$this->db->where('tbl_ot.date_ot >=', $start_date);
		$this->db->where('tbl_ot.date_ot <=', $end_date);
		$this->db->where('(tbl_ot.status = "FOR APPROVAL" AND admin1.department_id = '. 2 .' OR admin1.department_id = '. 5 . ' AND tbl_ot.status = "FOR APPROVAL" OR admin1.is_rfa = '. 1 . ' AND tbl_ot.status = "FOR APPROVAL" OR admin1.is_fa != '. 0 .' AND tbl_ot.status = "FOR APPROVAL"  OR tbl_ot.status = "FOR NOTED")');
	...
	public function get_ob_all_by_headCAM($start_date, $end_date, $department_id)
	{
		...
		$this->db->where('tbl_ob.date_ob >=', $start_date);
		$this->db->where('tbl_ob.date_ob <=', $end_date);
		$this->db->where('(tbl_ob.remarks = "FOR APPROVAL" AND admin1.department_id = '. 2 .' OR admin1.department_id = '. 5 . ' AND tbl_ob.remarks = "FOR APPROVAL" OR admin1.is_rfa = '. 1 . ' AND tbl_ob.remarks = "FOR APPROVAL" OR admin1.is_fa != '. 0 .' AND tbl_ob.remarks = "FOR APPROVAL"  OR tbl_ob.remarks = "FOR NOTED")');
	...
	public function get_slvl_all_by_isHr_and_isVerify($start_date, $end_date, $department_id)
	{
		$this->db->select("
			tbl_slvl.id as id, 
			tbl_slvl.employee_number as employee_number, 
		...
		$this->db->where('tbl_slvl.date >=', $start_date);
		$this->db->where('tbl_slvl.date <=', $end_date);
		$this->db->where('(tbl_slvl.status = "Recommending for Approval" AND admin1.department_id = '. $department_id .' OR tbl_slvl.staTUS = "FOR APPROVAL" AND admin1.department_id = '. $department_id .' OR tbl_slvl.status = "FOR VERIFY")');
	...
	public function get_ot_all_by_isHr_and_isVerify($start_date, $end_date, $department_id)
	{
		$this->db->select('
			tbl_ot.id as id, 
			tbl_ot.employee_number as employee_number, 
		...
		$this->db->where('tbl_ot.date_ot >=', $start_date);
		$this->db->where('tbl_ot.date_ot <=', $end_date);
		$this->db->where('(tbl_ot.status = "Recommending for Approval" AND admin1.department_id = '. $department_id .' OR tbl_ot.staTUS = "FOR APPROVAL" AND admin1.department_id = '. $department_id .' OR tbl_ot.status = "FOR VERIFY")');
	...
	public function get_ob_all_by_isHr_and_isVerify($start_date, $end_date, $department_id)
	{
		$this->db->select('
			tbl_ob.id as id, 
			tbl_ob.employee_number as employee_number, 
		...
		$this->db->join('tbl_employees', 'tbl_ob.employee_number = tbl_employees.employee_number');
		$this->db->join('admin1', 'tbl_ob.employee_number = admin1.emp_no_id', 'left');
		$this->db->order_by('tbl_ot.remarks', 'DESC');
		$this->db->order_by('tbl_ob.date_ob', 'ASC');
		$this->db->order_by('tbl_ob.name', 'ASC');
		$this->db->where('tbl_ob.date_ob >=', $start_date);
		$this->db->where('tbl_ob.date_ob <=', $end_date);
		$this->db->where('(tbl_ob.remarks = "Recommending for Approval" AND admin1.department_id = '. $department_id .' OR tbl_ob.remarks = "FOR APPROVAL" AND admin1.department_id = '. $department_id .' OR tbl_ob.remarks = "FOR VERIFY")');
	...
	public function get_ut_all_by_isHr_and_isVerify($start_date, $end_date, $department_id)
	{
		$this->db->select('
			tbl_undertime.id as id,
			tbl_undertime.employee_number as employee_number, 
		...
		$this->db->where('tbl_undertime.date_ut >=', $start_date);
		$this->db->where('tbl_undertime.date_ut <=', $end_date);
		$this->db->where('(tbl_undertime.status = "Recommending for Approval" AND admin1.department_id = '. $department_id .' OR tbl_undertime.status = "FOR APPROVAL" AND admin1.department_id = '. $department_id .' OR tbl_undertime.status = "FOR VERIFY")');
	...
	public function get_slvl_allbranch_rfv($start_date, $end_date)
	{
		$this->db->select("
			tbl_slvl.id as id, 
			tbl_slvl.employee_number as employee_number, 
		...
		$this->db->where('tbl_slvl.date >=', $start_date);
		$this->db->where('tbl_slvl.date <=', $end_date);
		$this->db->where('tbl_slvl.status ', 'Recommending for Verify');
	...
	public function get_ut_allbranch_rfv($start_date, $end_date)
	{
		$this->db->select('
			tbl_undertime.id as id,
			tbl_undertime.employee_number as employee_number, 
		...
		$this->db->where('tbl_undertime.date_ut >=', $start_date);
		$this->db->where('tbl_undertime.date_ut <=', $end_date);
		$this->db->where('tbl_undertime.status ', 'Recommending for Verify');
	...
	public function get_ot_allbranch_rfv($start_date, $end_date)
	{
		$this->db->select('
			tbl_ot.id as id, 
			tbl_ot.employee_number as employee_number, 
		...
		$this->db->order_by('tbl_ot.name', 'ASC');
		$this->db->order_by('tbl_ot.date_ot', 'ASC');
		$this->db->where('tbl_ot.status', 'Recommending for Verify');
		$this->db->where('tbl_ot.date_ot >=', $start_date);
		$this->db->where('tbl_ot.date_ot <=', $end_date);
	...
	public function get_ob_allbranch_rfv($start_date, $end_date)
	{
		$this->db->select("
			tbl_ob.id as id, 
			tbl_ob.employee_number as employee_number, 
		...
		$this->db->where('tbl_ob.date_ob >=', $start_date);
		$this->db->where('tbl_ob.date_ob <=', $end_date);
		$this->db->where('tbl_ob.remarks ', 'Recommending for Verify');
	...
	public function get_ut_allbranch_process($start_date, $end_date)
	{
		$this->db->select('
			tbl_undertime.id as id,
			tbl_undertime.employee_number as employee_number, 
		...
		$this->db->where('tbl_undertime.date_ut >=', $start_date);
		$this->db->where('tbl_undertime.date_ut <=', $end_date);
		$this->db->where('tbl_undertime.status ', 'FOR PROCESS');
		$query = $this->db->get();
	...
	public function get_ot_allbranch_process($start_date, $end_date)
	{
		$this->db->select('
			tbl_ot.id as id, 
			tbl_ot.employee_number as employee_number, 
		...
		$this->db->where('tbl_ot.date_ot >=', $start_date);
		$this->db->where('tbl_ot.date_ot <=', $end_date);
		$this->db->where('tbl_ot.status ', 'FOR PROCESS');
		$query = $this->db->get();
	...
	public function get_ob_allbranch_process($start_date, $end_date)
	{
		$this->db->select("
			tbl_ob.id as id, 
			tbl_ob.employee_number as employee_number, 
		...
		$this->db->where('tbl_ob.date_ob >=', $start_date);
		$this->db->where('tbl_ob.date_ob <=', $end_date);
		$this->db->where('tbl_ob.remarks ', 'FOR PROCESS');
